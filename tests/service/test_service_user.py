...
class TestServiceUser:
    ...
    def test_add_user_success(self):
        ...
        response = service.add_user("ermeson", "development")
    ...
    def test_add_user_just_exist(self):
        ...
        service.add_user("ermeson", "development")
        response = service.add_user("ermeson", "development")
    ...
    def test_update_user_invalid_job(self):
        ...
        response = service.update_user("ermeson", None)
    ...
    def test_search_user(self):
        service = ServiceUser()
        response_assert = "ermeson"

        service.add_user("ermeson", "development")
        response_user = service.search_user("ermeson")
